...
<div class="container mx-auto mb-10">
    <div class="border rounded-lg p-2 text-sm relative bg-base-100 m-4 md:text-base md:p-6 min-h-screen">
        <div class="flex flex-wrap md:flex-nowrap pt-3 pb-2 mb-2 border-b-2">
            <h1 class="font-semibold mx-auto">Tambah soal untuk materi <span class="font-semibold">{{ $subject->title }}</span></h1>
        </div>
        
        <form class="mt-4 px-3" method="POST" action="/questions/{{ $subject->slug }}" enctype="multipart/form-data">
            @csrf
            <div>
                <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <input id="subject_id" name="subject_id" type="hidden" value="{{ $subject->id}}">
                    <div class="sm:col-span-4">
                        <label for="code" class="block text-sm font-medium leading-6 text-gray-900 label-text">Jenis Soal <span class="text-xs font-semibold">pastikan jenis soal sesuai dengan yang diinginkan</span>
                        </label>
                        <div class="mt-2">
                            <select name="code" id="code" class="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6">
                                @foreach ($codes as $code)
                                    @if (old('code') == $code['key'])
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <img class="img-preview mb-3 w-3/12 h-auto" alt="">
                        <div class="mt-2">
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <textarea id="option_a" name="option_a" rows="3" class="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6" required placeholder="Opsi A" >{{ old('option_a') }}</textarea>
                            @error('option_a')
                                <div>
                                    <p class="text-red-500 text-sm m-1">
                                            {{ $message }}
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <textarea id="option_b" name="option_b" rows="3" class="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:outline-none  focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6" required placeholder="Opsi B" >{{ old('option_b') }}</textarea>
                            @error('option_b')
                                <div>
                                    <p class="text-red-500 text-sm m-1">
                                            {{ $message }}
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <textarea id="option_c" name="option_c" rows="3" class="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:outline-none  focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6" required placeholder="Opsi C" >{{ old('option_c') }}</textarea>
                            @error('option_c')
                                <div>
                                    <p class="text-red-500 text-sm m-1">
                                            {{ $message }}
                    ...
                    <div class="sm:col-span-4">
                        <label for="option_d" class="block text-sm font-medium leading-6 text-gray-900">Opsi D</label>
                        <div class="mt-2">
                            <textarea id="option_d" name="option_d" rows="3" class="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:outline-none  focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6" required placeholder="Opsi D" >{{ old('option_d') }}</textarea>
                            @error('option_d')
                                <div>
                                    <p class="text-red-500 text-sm m-1">
                                            {{ $message }}
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <textarea id="option_e" name="option_e" rows="3" class="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:outline-none  focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6" required placeholder="Opsi E" >{{ old('option_e') }}</textarea>
                            @error('option_e')
                                <div>
                                    <p class="text-red-500 text-sm m-1">
                                            {{ $message }}
                        ...
                        <div class="mt-2">
                            <select name="answer_key" id="answer_key" class="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6">
                                @foreach ($answer_keys as $answer_key)
                                    @if (old('answer_key') == $answer_key['key'])
