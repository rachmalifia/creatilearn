...
@section('greeting')
<div>
    <h5 class="mx-6 mt-4 text-sm md:text-base font-semibold">Data Nilai Siswa</h5>
</div>
@endsection
  ...
  <div class="border rounded-lg p-2 text-sm relative bg-base-100 m-4 md:text-base md:p-6 min-h-screen">
    ...
    <details class="collapse collapse-arrow bg-base-300 mb-4">
        ...
        <div class="collapse-content">
            {{-- && $subjects[$loop->index]->course_id == $course->id --}}
            @if ($subjects->count())    
                        ...
                        @foreach ($subjects as $subject)
                            @if ($subject->course_id == $course->id)    
                                <tr>
                                    ...
                                    <td>
                                        {{-- Show ALL student result data where ID Subject --}}
                                        <a href="/all-students-result/{{ $subject->slug }}" class="badge badge-info gap-2">
            ...
            <div class="flex items-center justify-center">
                <p class="text-sm md:text-base text-center text-gray-600 p-2">Belum ada data materi pada pelajaran ini</p>
            </div>
            @endif
    </details>
    @endforeach   
